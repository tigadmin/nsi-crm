...
import {reporter, system} from '@cortezaproject/corteza-js'
...
import DisplayElementConfigurator
	from 'corteza-webapp-reporter/src/components/Report/Blocks/DisplayElements/Configurators'
